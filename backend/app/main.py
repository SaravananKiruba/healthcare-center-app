...
def get_dashboard_stats(
    ...
    total_investigations = db.query(models.Investigation).count()
...
async def startup_event():
    ...
    try:
        ...
        if not doctor_user:
            ...
            db.add(doctor_user)
            print("Default doctor user created: doctor@healthcare.com / doctor123")
...
def staff_access_route(current_user: models.User = Depends(auth.require_role(["admin", "doctor"]))):
    """This route is accessible by staff members (admin, doctor)"""
    return {
